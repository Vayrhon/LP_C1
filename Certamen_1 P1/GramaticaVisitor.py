...
#        self.num_capas = capa_manager.obtener_num_capas()
#        self.filas, self.columnas = capa_manager.obtener_dimensiones_capa()
    ...
    # Visit a parse tree produced by GramaticaParser#VECINOS.
