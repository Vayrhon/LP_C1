...
class GramaticaVisitor(ParseTreeVisitor):
    ...
    def visitCAPA(self, ctx:GramaticaParser.CAPAContext):
        ...
        for i in range(dimensiones[0]):
            ...
            for j in range(dimensiones[1]):
                ...
                total_por_celda = 80  # Valor Inicial de poblacion en la celda
    ...
    def inicializar_poblacion(self, total_por_celda):
        ...
        # Asegurar que siempre haya al menos un infectado
        poblacion_celda['I'] = random.randint(1, total_por_celda)
        total_por_celda -= poblacion_celda['I']
        
        # Distribuir el resto de la población de manera aleatoria sin pasarse de total_por_celda
        estados = ['S', 'E', 'R']  # No incluir 'I' en la distribución aleatoria
